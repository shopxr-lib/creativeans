...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 z-20 h-screen w-screen transform overflow-y-scroll bg-[#f7f8fc] px-12 pb-[200px] pt-[200px] transition-transform duration-300 ease-in-out lg:w-1/2 lg:pt-[160px] ${
