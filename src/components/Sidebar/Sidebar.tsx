...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 z-20 h-screen w-screen transform overflow-y-scroll bg-[#f7f8fc] px-12 pb-[300px] pt-[100px] transition-transform duration-300 ease-in-out lg:w-1/2 lg:pt-[160px] ${
          ...
          <div data-label="body" className="mb-20 sm:mb-0">
            {sidebarInfo && (
              <div className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-[210px] items-center gap-4 sm:grid-cols-[210px,210px]">
